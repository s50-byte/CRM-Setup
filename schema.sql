...
CREATE TYPE benutzer_system_rolle AS ENUM (
...
CREATE TABLE benutzer (
    ...
    system_rolle    benutzer_system_rolle NOT NULL DEFAULT 'mitarbeitende',
    aktiv           BOOLEAN NOT NULL DEFAULT TRUE,
    created_at      TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at      TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

-- Aufgabenbereiche pro Benutzer (Casemanagement, Job Coach etc.)
CREATE TABLE benutzer_aufgabe (
    aufgabe_id   UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE team_mitglied (
    ...
    user_id              UUID NOT NULL REFERENCES benutzer(user_id) ON DELETE CASCADE,
    aufgabe_id           UUID REFERENCES benutzer_aufgabe(aufgabe_id),
...
\echo ''
\echo '======================================'
\echo ' IV-CRM Schema v2 erfolgreich erstellt'
\echo ' Tabellen, Indizes und Grunddaten OK'
\echo '======================================'